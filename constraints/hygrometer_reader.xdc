...
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports {serial_clk}];#Sch name = JB9
set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 } [get_ports {serial_data}];#Sch name = JB10
